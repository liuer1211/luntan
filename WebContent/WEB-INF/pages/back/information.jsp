...
<div class="page-container">
	<div class="text-c">
		...
		<input type="text" class="input-text" style="width:150px" placeholder="输入新闻标题" id="title" name="title">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			...
			<a href="${prc}/manager/addInformationView"  class="btn btn-primary radius">
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        table = $("#datatable").dataTable({
            ...
            ajax: function (data, callback, settings) {
                ...
                $.ajax({
                    type: "post",
                    url: "${prc}/manager/getInformationList",
                    cache: false,  //禁用缓存
                    data: param,  //传入组装的参数
                    dataType: "json",
            ...
            columns: [
                ...
                { "data": "picture" ,
                    ...
                    render : function(data, type, row) {
                        ...
                        {
                            s='<img style="height: 20px" src="'+'${prc}/image/init/new.jpg'+'"/>';
                        }
                        return s;
                    }
                },
                ...
                { "data": "id",
                    render : function(data, type, row) {
                        return '<a title="编辑" href="javascript:;" onclick="information_edit('+"'"+data+"'"+')" class="ml-5" style="text-decoration:none">'+
                        '<i class="Hui-iconfont"> &#xe6df; </i>'+
                        '</a>'+
                        '<a title="删除" href="javascript:;" onclick="information_del('+"'"+data+"'"+')" class="ml-5" style="text-decoration:none">'+
                        '<i class="Hui-iconfont"> &#xe6e2; </i>'+
                        '</a>';
                    }
                }
   ...
   function datadel(){
	    ...
	    if(rows.length==0){
	    	...
	    	layer.confirm('确认要删除吗？',function(index){
	    		$.ajax({
	    			type:'post',
	    			url:'${prc}/manager/informationDelete',
	    			dataType:'json',
	    			data:data,
   ...
   //编辑
   //id是参数
   function information_edit(id){
	   layer_show("编辑","${prc}/manager/editInformationView?id="+id,'','510');
   } 
   
   //单个删除
   function information_del(id){
