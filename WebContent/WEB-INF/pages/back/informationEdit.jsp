	...
	<form id="J_basic" action="#" method="post" class="form form-horizontal" >
		...
		<%-- <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<input type="text" class="input-text" placeholder="" value="${info.title}" name="title" id="title">
			</div>
		</div> --%>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>链接地址：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${info.link}" placeholder="" id="link" name="link">
			</div>
		</div>
		<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<textarea name="content" cols="" rows="" class="textarea"
						...
						nullmsg="备注不能为空！">${info.content}</textarea>
				</div>
			</div>
		<div class="row cl">
...
<script type="text/javascript">
    ...
    function submit(data){
        $.ajax({
            url: '${prc}/manager/informationUpdate',
            type: 'post',
            dataType: 'json',
