...
<div class="page-container">
	<!-- <div class="text-c">
		<input type="text" class="input-text" style="width:150px" placeholder="输入用户名" id="name" name="name">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			...
			<!-- javascript:; 需要触发事件而不需要返回值 -->
			<%-- <a href="javascript:;" onclick="member_add('添加管理员','${prc}/manager/addView','','510')" 
				class="btn btn-primary radius">
				<i class="Hui-iconfont">&#xe600;</i> 添加
			</a> --%>
			<%-- <a href="${prc}/manager/addView" 
				class="btn btn-primary radius">
				<i class="Hui-iconfont">&#xe600;</i> 添加
			</a> --%>
		</span>
    ...
    $(function(){
        ...
        table = $("#datatable").dataTable({
            ...
            ajax: function (data, callback, settings) {
                ...
                $.ajax({
                    type: "post",
                    url: "${prc}/manager/getManagerList",
                    cache: false,  //禁用缓存
                    data: param,  //传入组装的参数
                    dataType: "json",
            ...
            columns: [
                ...
                { "data": "id",
                    render : function(data, type, row) {
                        return '<a title="编辑" href="javascript:;" onclick="manager_edit('+"'"+data+"'"+')" class="ml-5" style="text-decoration:none">'+
