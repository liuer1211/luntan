...
<div class="page-container">
	<div class="text-c">
		...
		<span class="select-box" style="width:150px">
			<select class="select" id="gender" name="gender" size="1">
    ...
    $(function(){
        ...
        table = $("#datatable").dataTable({
            ...
            columns: [
                ...
                { "data": "id",
                    render : function(data, type, row) {
                        return '<a title="删除" href="javascript:;" onclick="user_del('+"'"+data+"'"+')" class="ml-5" style="text-decoration:none">'+
