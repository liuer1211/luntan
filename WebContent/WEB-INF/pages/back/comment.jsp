    ...
    $(function(){
        ...
        table = $("#datatable").dataTable({
            ...
            ajax: function (data, callback, settings) {
                ...
                $.ajax({
                    type: "post",
                    url: "${prc}/manager/getCommentList",
                    cache: false,  //禁用缓存
                    data: param,  //传入组装的参数
                    dataType: "json",
            ...
            columns: [
                ...
                { "data": "id",
                    render : function(data, type, row) {
                        return '<a title="删除" href="javascript:;" onclick="comment_del('+"'"+data+"'"+')" class="ml-5" style="text-decoration:none">'+
