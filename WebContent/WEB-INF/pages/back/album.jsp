...
<div class="page-container">
	<div class="text-c">
		...
		<input type="text" class="input-text" style="width:150px" placeholder="输入标题" id="title" name="title">
		<input type="text" class="input-text" style="width:150px" placeholder="输入创建者" id="name" name="name">
    ...
    $(function(){
        ...
        table = $("#datatable").dataTable({
            ...
            columns: [
                ...
                { "data": "id",
                    render : function(data, type, row) {
                        return '<a title="删除" href="javascript:;" onclick="album_del('+"'"+data+"'"+')" class="ml-5" style="text-decoration:none">'+
