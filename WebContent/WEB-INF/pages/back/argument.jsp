...
<div class="page-container">
	<div class="text-c">
		...
		<input type="text" class="input-text" style="width:150px" placeholder="输入主题" id="title" name="title">
		<span class="select-box" style="width:150px">
			<select class="select" id="property" name="property" size="1">
				<option value="">言论属性</option>
    ...
    $(function(){
        ...
        table = $("#datatable").dataTable({
            ...
            ajax: function (data, callback, settings) {
                ...
                $.ajax({
                    type: "post",
                    url: "${prc}/manager/getArgumentList",
                    cache: false,  //禁用缓存
                    data: param,  //传入组装的参数
                    dataType: "json",
            ...
            columns: [
                ...
                { "data": "id",
                    render : function(data, type, row) {
                        return '<a title="删除" href="javascript:;" onclick="argument_del('+"'"+data+"'"+')" class="ml-5" style="text-decoration:none">'+
   ...
   function datadel(){
	    ...
	    if(rows.length==0){
	    	...
	    	layer.confirm('确认要删除吗？',function(index){
	    		$.ajax({
	    			type:'post',
	    			url:'${prc}/manager/argumentDelete',
	    			dataType:'json',
	    			data:data,
