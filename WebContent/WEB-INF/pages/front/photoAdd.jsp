					...
					<div class="panel-body">
						<div class="row">
							...
							<div class="col-md-12">
								<div class="thumbnail" >
									<!-- form表单 -->
									<form class="form-horizontal" method="post" action="${prc }/photo/photoSave" enctype="multipart/form-data" id="myForm">
										<input type="hidden" name="albumId" value="${listOneAlbum.id }">
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<img src="${prc}/tmp/tp.jpg" class="img-rounds" width="100/9" id="img1">
