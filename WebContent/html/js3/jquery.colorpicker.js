    ...
    $.fn.colorpicker = function(options) {
        ...
        return this.each(function(){
            ...
            obj.bind(opts.event,function(){
                ...
                var tleft = $(this).offset().left-100;    //控件的定位点宽
                $("#colorpanel").css({
                    top:ttop-200,
                    left:tleft,
                    height:200
        ...
        function initColor(){
            ...
            +'<td width="3"><td><input type="text" id="HexColor" size="7" style="border:inset 1px;font-family:Arial;" value="#000000"><a href="javascript:void(0);" id="_cclose">关闭</a></td></tr></table></td></table>'
